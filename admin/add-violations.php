                ...
                <div class="card-body">
                  ...
                  <form id="add-violation-form" class="forms-sample">
                    <div class="form-group">
                      ...
                      <select name="student_id" class="form-control custom-input" required style="border: 1px solid #acb7c2; outline: none;">
                        <?php
                    ...
                    <div class="form-group">
                      ...
                      <select name="violation_type" class="form-control custom-input" required style="border: 1px solid #acb7c2; outline: none;">
                        <?php
                    ...
                    <div class="form-group">
                      ...
                      <select name="description" class="form-control custom-input" required style="border: 1px solid #acb7c2; outline: none;">
