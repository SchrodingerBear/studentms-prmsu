                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" action="between-date-reprtsdetails.php">
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" id="fromdate" name="fromdate" value="" required='true'style="border: 1px solid #ccc;">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputName1">To Date:</label>
                          <input type="date" class="form-control" id="todate" name="todate" value="" required='true'style="border: 1px solid #ccc;">
                        </div>
