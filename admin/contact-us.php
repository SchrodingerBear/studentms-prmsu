                ...
                <div class='toast-container position-fixed top-0 start-50 translate-middle-x p-3'>
                    <div id='updateSuccessToast' class='toast' role='alert' aria-live='assertive' aria-atomic='true' style='background-color: #1c82e6; color: white;'>
                        <div class='toast-body'>
                            Contact Us has been successfully updated.
                        </div>
                    </div>
                </div>
                <script>
...
?>
    ...
    <head>
      ...
      <title>STUDENT HANDBOOK ASSISTANCE | Update Contact Us</title>
      <!-- plugins:css -->
            ...
            <div class="content-wrapper"style="background-color: #c71d68;">
              ...
              <div class="row">
                ...
                <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title" style="text-align: center;">Update Contact </h4>
