...
<head>
 ...
 <style>
        ...
        h3 {
            ...
            color: #1c82e6; /* Matching header color */
        }
        .custom-input {
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="stuname" id="stuname" value="<?php echo htmlentities($student->StudentName); ?>" class="form-control custom-input" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="verify">Verification Status</label>
                                            <select name="verify" class="form-control custom-input" required style="border: 1px solid #acb7c2; outline: none;"> 
                                                <option value="1" <?php if ($student->verify == 1) echo 'selected'; ?>>Verified</option>
                                                <option value="0" <?php if ($student->verify == 0) echo 'selected'; ?>>Not Verified</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="stuemail">Student Email</label>
                                            <input type="email" name="stuemail" value="<?php echo htmlentities($student->StudentEmail); ?>" class="form-control custom-input" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="stuclass">Student Class</label>
                                            <select name="stuclass" class="form-control custom-input" required style="border: 1px solid #acb7c2; outline: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="altconnum" id="altconnum" value="<?php echo htmlentities($student->AltenateNumber); ?>" class="form-control custom-input" required='true' maxlength="11">
                                        </div>
                                        <div class="form-group">
                                            <label for="gender">Gender</label>
                                            <select name="gender" id="gender" class="form-control custom-input" required style="border: 1px solid #acb7c2; outline: none;">
                                                <option value="<?php echo htmlentities($student->Gender); ?>"><?php echo htmlentities($student->Gender); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="dob" value="<?php echo htmlentities($student->DOB); ?>" class="form-control custom-input" required='true'>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fname" id="fname" value="<?php echo htmlentities($student->FatherName); ?>" class="form-control custom-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="mname">Mother's Name</label>
                                            <input type="text" name="mname" id="mname" value="<?php echo htmlentities($student->MotherName); ?>" class="form-control custom-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="connum">Contact Number</label>
                                            <input type="text" name="connum" id="connum" value="<?php echo htmlentities($student->ContactNumber); ?>" class="form-control custom-input" required='true' maxlength="11">
                                        </div>
                                        <div class="form-group">
                                            <label for="address">Address</label>
                                            <textarea name="address" class="form-control custom-input" required='true'><?php echo htmlentities($student->Address); ?></textarea>
                                        </div>
                                           <h3>Login details</h3>
                                        <div class="form-group">
                                            <label for="stuid">Student ID</label>
                                            <input type="text" name="stuid" value="<?php echo htmlentities($student->StuID); ?>" class="form-control custom-input " readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Password</label>
                                            <input type="text" name="password" value="<?php echo htmlentities($student->Password); ?>" class="form-control custom-input">
                                        </div>
                                    
                                     <button type="submit" name="submit" class="custom-add-btn">Update</button>
                                       <button type="button" class="custom-add-btn" onclick="window.location.href='manage-students.php'">Cancel</button>
                                    </form>
                                </div>
                            </div>
                        </div>
