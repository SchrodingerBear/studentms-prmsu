  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="add-notice.php"> Add Class Notice </a></li>
          ...
          <li class="nav-item"> <a class="nav-link" href="manage-public-notice.php"> Manage Notice </a></li>
        </ul>
      </div>
    </li>
    <!-- <li class="nav-item">
