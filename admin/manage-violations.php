...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_GET['delid'])) {
    ...
    $sql = "DELETE FROM violations WHERE id = :rid";
    ...
    if ($query->execute()) {
      echo "<script>
                    ...
                    window.location.href = 'manage-violations.php';
                  </script>";
    } else {
      $errorInfo = $query->errorInfo();
      echo "<script>alert('Error deleting record: " . $errorInfo[2] . "');</script>";
    }
  }
  ?>
  <!DOCTYPE html>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-responsive" id="table">
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT v.id, s.StudentName, c.ClassName, c.Section, v.violation_date, v.violation_type, v.description, v.Sanction, v.penalty
                            FROM violations v 
                            ...
                            foreach ($results as $row) {
                              ...
                              <tr>
                                ...
                                <td>
                                  <div>
                                    <a class="mr-2"
                                      href="rest/print-data.php?violationID=<?php echo htmlentities($row->id); ?>"><i
                                        class="icon-printer"></i></a>
                                    <a class="mr-2"
                                      href="edit-violation-detail.php?editid=<?php echo htmlentities($row->id); ?>"><i
                                        class="icon-eye"></i></a>
