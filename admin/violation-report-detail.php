                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    $tdate = $_POST['todate'];
                                    ?>
                                    <h5 align="center" style="color:blue">Violation Report from <?php echo $fdate ?> To
                                        <?php echo $tdate ?>
                                    </h5>
                                    <div style="text-align: right; margin-bottom: 10px;">
                                        <i class="fas fa-print" style="font-size: 24px; cursor: pointer;"
                                            onclick="printReport()" title="Print Report"></i>
                                    </div>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="font-weight-bold">Sanction</th>
                                            ...
                                            <tbody>
                                                ...
                                                $ret = "SELECT ID FROM tblviolation";
                                                ...
                                                $sql = "SELECT tblviolation.student_id, tblviolation.violation_date, tblviolation.violation_type, tblviolation.description, tblviolation.sanction, tblviolation.penalty, tblstudent.StuID, tblstudent.StudentName 
                        FROM tblviolation 
                        JOIN tblstudent ON tblviolation.student_id = tblstudent.ID 
                        WHERE date(tblviolation.violation_date) BETWEEN '$fdate' AND '$tdate' 
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $row) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row->sanction); ?></td>
