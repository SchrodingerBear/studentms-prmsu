...
<div class="form-group">
    ...
    <input type="text" name="altconnum" id="altconnum" class="form-control custom-input" required pattern="\d{11}" title="Contact number must be exactly 11 digits">
</div>
  <div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="connum" id="connum" class="form-control custom-input" pattern="\d{11}" title="Contact number must be exactly 11 digits">
</div>
<div class="form-group">
    <label for="address">Address</label>
    <textarea name="address" id="address" class="form-control custom-input" required placeholder="purok/barangay/municipality/province"></textarea>
</div>
...
.custom-input {
    ...
    border-radius: 5px; 
    padding: 3px; /* Reduced padding for smaller placeholder */
    transition: border-color 0.3s ease; 
