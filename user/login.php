...
if (isset($_POST['login'])) {
  ...
  // Initial query for tblstudent
  $sql = "SELECT StuID, ID, StudentClass, verify FROM tblstudent WHERE (UserName=:stuid OR StuID=:stuid) AND Password=:password";
...
<head>
  ...
  <style>
    ...
    .form-control {
      ...
      /* Thicker border with a light gray color */
      border-radius: 5px;
      /* Rounded corners for a smoother look */
      padding: 10px;
      /* Add padding for more space inside the input */
    ...
    .form-control:hover {
      border-color: #FED365;
      /* Change border color to yellow on hover */
    }
      ...
      <div class="row flex-grow">
        <div class="col-lg-4 mx-auto">
          <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" id="login" method="post" name="login">
                ...
                <div class="form-group mt-4"> <!-- Added more top margin -->
                  <input id="usernameInput" type="text" class="form-control form-control-lg"
                    placeholder="Student ID or Admin Credentials" required="true" name="stuid" value="<?php if (isset($_COOKIE["user_login"])) {
            ...
            <a href="javascript:void(0);" class="auth-link small-font" id="openModal">Don't have an account? Register
              here</a>
